...
public class TileVisualizer extends JPanel {
    ...
    MouseAdapter createMouseListener() {
        ...
        return new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                ...
                stampCreationTool.setVisible(false);
            ...
            boolean isInMenu(int mouseX, int mouseY) {
            ...
            void handleLeftClick(MouseEvent e) {
                ...
                int scaledMouseX = (int) ((mouseX + getViewPosition().x) / getZoomLevel());
                
                int scaledMouseY = (int) ((mouseY + getViewPosition().y) / getZoomLevel());

                int col = (scaledMouseX - 20) / (tileSize + spacing);
                
                int row = (scaledMouseY - 50) / (tileSize + spacing);
        ...
        return new MouseMotionAdapter() {
            ...
            public void mouseDragged(MouseEvent e) {
                ...
                if (mousePressed && !isContextMenuVisible && SwingUtilities.isMiddleMouseButton(e) && e.isControlDown()) {
                    ...
                    getViewPosition().translate(-dx, -dy);
        ...
        return new MouseAdapter() {
            ...
            public void mouseWheelMoved(MouseWheelEvent e) {
                ...
                if (!isContextMenuVisible && e.isControlDown()) {
                    ...
                    getViewPosition().x = (int) ((getViewPosition().x + mouseX / oldZoomLevel) - mouseX / getZoomLevel());
                    
                    getViewPosition().y = (int) ((getViewPosition().y + mouseY / oldZoomLevel) - mouseY / getZoomLevel());
    ...
    protected void paintComponent(Graphics g) {
        ...
        for (int row = 0; row < numRows && row < getMap().length; row++) {
            ...
            if (getMap()[row] != null) {
                ...
                for (int col = 0; col < numCols && col < getMap()[row].length; col++) {
                    ...
                    g2d.drawImage(tileImage, x - getViewPosition().x, y - getViewPosition().y, tileSize, tileSize, null);
                }
            }
        }
        ...
        if (showPreview && !stampCreationTool.isVisible() && mousePosition != null) {
            ...
            int previewX = (int) ((mousePosition.x + getViewPosition().x) / getZoomLevel());
            
            int previewY = (int) ((mousePosition.y + getViewPosition().y) / getZoomLevel());
            ...
            if (col >= 0 && col < numCols && row >= 0 && row < numRows) {
                ...
                if (stampTool.isActive() && stampTool.getStampPattern(stampTool.currentStampIndex) != null) {
                    ...
                    for (int i = 0; i < stampRows; i++) {
                        ...
                        for (int j = 0; j < stampCols; j++) {
                            ...
                            if (stampTileIndex >= 0 && stampTileIndex < tileImages.length) {
                                ...
                                g2d.drawImage(stampTileImage, x - getViewPosition().x, y - getViewPosition().y, tileSize, tileSize, null);
                    ...
                    if (selectedTileIndex >= 0 && selectedTileIndex < tileImages.length) {
                        ...
                        g2d.setComposite(AlphaComposite.getInstance(AlphaComposite.SRC_OVER, previewTransparency))
                        ;
                        g2d.drawImage(selectedTileImage, x - getViewPosition().x, y - getViewPosition().y, tileSize, tileSize, null);
